...
CREATE INDEX idx_hidden_patterns_country ON hidden_patterns(country_id);
...
CREATE INDEX idx_reports_status ON pattern_reports(status);
CREATE INDEX idx_reports_country ON pattern_reports(country_id);
CREATE INDEX idx_reports_created ON pattern_reports(created_at DESC);
